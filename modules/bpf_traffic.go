...
var (
	...
	ErrCreatingPodEgressEventRingBufReader   = errors.New("failed to create a event reader for egress pod events")
	ErrCreatingEgressErrorEventRingBufReader = errors.New("failed to create an event reader for egress errors")
	...
	ErrReadingFromEventRingBufReader = errors.New("failed to read from the event ringbuf reader")
	ErrReadingFromErrorRingBufReader = errors.New("failed to read from the error ringbuf reader")
)
